...
###2. Study Design
  ...
  The data for the project is collected from the accelerometers from the Samsung Galaxy S smartphone. 
  ...
  More detail can be obtained at the study web site.
...
The data cleaning process are performed based on the following steps:
  ...
  2.	Read data files and merge into 3 data sets (each has 10299 observtions)
      ...
      <table><tr><td>a.	myData</td></tr>
      <tr><td>b.	myLabel</td></tr>
      <tr><td>c.	mySubject</td></tr></table>
